...
namespace gridftpd {
  ...
  class Run {
   private:
    ...
    static bool int_detected;
    static bool term_detected;
    ...
    static void sig_int(int signum,siginfo_t *info,void* arg);
