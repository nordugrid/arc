...
class HashClient(Client):
    ...
    def get_tree(self, IDs, neededMetadata = []):
        ...
        rewrite = {
            hash_prefix + ':objects' : 'lbr:getResponseList',
            hash_prefix + ':object' : 'lbr:getResponseElement',
            hash_prefix + ':ID' : 'lbr:GUID',
            hash_prefix + ':metadataList' : 'lbr:metadataList',
            hash_prefix + ':metadata' : 'lbr:metadata',
            hash_prefix + ':section' : 'lbr:section',
            hash_prefix + ':property' : 'lbr:property',
            hash_prefix + ':value' : 'lbr:value'
        }
            ...
            ('lbr:new', [
                ('lbr:newRequestList', [
                    ('lbr:newRequestElement', [
                        ...
                        ('lbr:metadataList', create_metadata(metadata, 'cat'))
