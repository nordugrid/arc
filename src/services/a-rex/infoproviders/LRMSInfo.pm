...
my $lrms_info_schema = {
    ...
    'queues' => {
        '*' => {
            ...
            'mincputime'   => '*', # units: minutes
            'defaultcput'  => '*', # units: minutes
            'maxwalltime'  => '*', # units: minutes
            'minwalltime'  => '*', # units: minutes
            'defaultwallt' => '*', # units: minutes
    ...
    'jobs' => {
        '*' => {
            ...
            'cputime'     => '*', # units: minutes
            'reqwalltime' => '*', # units: minutes
            'reqcputime'  => '*', # units: minutes
