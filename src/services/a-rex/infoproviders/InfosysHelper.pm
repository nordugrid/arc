...
sub waitForProvider {
    ...
    $log->info("Start waiting for notification from A-REX infoprovider");
    my $ret;
    eval {
    ...
    $log->info("Notification received from A-REX infoprovider");
    return 1;
}
...
sub createLdifScript {
    ...
    eval {
        ...
        die "file\n" unless print $h "# Autogenerated by A-REX infoprovider\n\n";
