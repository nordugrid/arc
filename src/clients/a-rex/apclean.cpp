...
class APCleanTool: public Arc::ClientTool {
 public:
  ...
  APCleanTool(int argc,char* argv[]):Arc::ClientTool("apclean") {
    ProcessOptions(argc,argv,"P:K:C:A:c:");
  };
  virtual void PrintHelp(void) {
    std::cout<<"apclean [-h] [-d debug_level] [-l logfile] [-P proxy_path] [-C certificate_path] [-K private_key_path] [-A CA_directory_path] [-c config_path] [service_url] id_file"<<std::endl;
