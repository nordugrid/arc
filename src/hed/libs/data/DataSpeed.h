...
namespace Arc {
  ...
  public:
    ...
    /// Constructor
    /// \param base time period used to average values (default 1 minute).
    /// \param min_speed minimal allowed speed (Butes per second).
    /// If speed drops and holds below threshold for min_speed_time_
    /// seconds error is triggered.
    ...
    /// \param min_speed minimal allowed speed (Butes per second). If speed
    /// drops and holds below threshold for min_speed_time_ seconds error
    /// is triggered.
    /// \param min_speed_time
