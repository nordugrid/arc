...
void CredentialTest::testhostcert() {
  ...
  Arc::Credential host_cert(host_cert_file, host_key_file, "",  CAcert, false, false, true);
...
void CredentialTest::testusercert() {
  ...
  Arc::Credential user_cert_bad(user_cert_file,user_key_file,".",CAcert,false,false,true,"Bad password");

  //Load signed user cert
  Arc::Credential user_cert(user_cert_file, user_key_file, ".", CAcert, false, false, true, user_passphrase);
...
void CredentialTest::testproxy() {
  ...
  //Load proxy
  Arc::Credential user_proxy(user_proxy_file,"",".",CAcert,false,false,true);
...
void CredentialTest::testproxy2proxy() {
  ...
  Arc::Credential signer1(signer_cert1, "", ".", CAcert, false, false, true);
  ...
  //Load the proxy
  Arc::Credential user_proxy1(user_proxy_file1,"",".",CAcert,false,false,true);
  ...
  Arc::Credential signer2(signer_cert2, "", ".", CAcert, false, false, true);
  ...
  //Load the proxy
  Arc::Credential user_proxy2(user_proxy_file2,"","",CAcert,false,false,true);
