...
class ClassLoader : public ModuleManager{
  ...
  public:
    ...
    LoadableClass *Instance(const std::string& classId, void* arg = NULL, const std::string& className = "");
    LoadableClass *Instance(void* arg = NULL, const std::string& className = "");
