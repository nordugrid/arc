...
namespace Arc {
  ...
  public:
     ...
     **/
    /// Either default system-wide CA configuration folder to be used
    bool systemcadir;
    /// Either multi-CA file from system-wide CA configuration to be used
    bool systemcafile;
    ...
    void SetSystemCA(bool useDir, bool useFile);
