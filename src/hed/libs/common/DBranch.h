...
class DItem {
 public:
  DItem(void) { };
  virtual ~DItem(void) { };
  virtual DItem* New(void) const { return new DItem; };
  virtual std::string str() const { return ""; };
  virtual bool operator==(const DItem&) { return false; };
  virtual bool operator<(const DItem&) { return false; };
  virtual bool operator>(const DItem&) { return false; };
  virtual bool operator<=(const DItem&) { return false; };
  virtual bool operator>=(const DItem&) { return false; };
  ...
  virtual DItem& operator=(const DItem&) { return *this; };
  virtual DItem& operator=(const std::string&) { return *this; };
};
...
class DItemString: public DItem {
 protected:
  std::string value_;
 public:
  DItemString(void);
