...
\usepackage{hhline}
\usepackage{hyperref}
\hypersetup{pdftex, colorlinks=true, linkcolor=blue, citecolor=blue, filecolor=blue, pagecolor=blue, urlcolor=blue, pdftitle=, pdfauthor=name, pdfsubject=, pdfkeywords=}
...
\bigskip
\clearpage\clearpage\setcounter{page}{1}\pagestyle{Convertiv}
...
\includegraphics[width=0in,height=0.0161in]{SecurityFrameworkofARC1-img5.png}

\includegraphics[width=5.7043in,height=5.6354in]{SecurityFrameworkofARC1-img6.png}
...
Content\\\hline}\begin{supertabular}{|m{1.2330599in}|m{2.5476599in}|m{1.7684599in}|}
...
\label{bkm:Ref204009974}\label{bkm:RefSecarcpdpconfigandpolicy}{\selectlanguage{english}\upshape\color{black}
XML schema with comments available at
...
\label{bkm:RefSecdelegsechandleconfig}{\selectlanguage{english}\upshape\color{black}
...
SecHandler configuration}
\label{bkm:RefSecuserametokenconfig}{\selectlanguage{english}\upshape\color{black}
Configuration XML schema with comments available at
...
{\selectlanguage{english}\upshape\color{black}
\texttt{\ \ \ \ {\textless}KeyPath{\textgreater}/path/to/key.pem{\textless}/KeyPath{\textgreater}}}

{\selectlanguage{english}\upshape\color{black}
\texttt{\ \ \ \ {\textless}CertificatePath{\textgreater}/path/to/cert.pem{\textless}/CertificatePath{\textgreater}}}
...
{\selectlanguage{english}\upshape\color{black}
\texttt{\ {\textless}/Chain{\textgreater}{\textless}/ArcConfig{\textgreater}}}
