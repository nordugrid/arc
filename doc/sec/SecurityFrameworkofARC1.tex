...
{\centering\selectlanguage{english}\itshape\color{black}
Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure7}}. The
...
{\centering\selectlanguage{english}\itshape\color{black}
Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure8}}. The
...
{\centering\selectlanguage{english}\itshape\color{black}
Figure
{\refstepcounter{Figure}\theFigure\label{seq:refFigure5}}.\textbf{
...
\end{center}
{\centering\selectlanguage{english}\itshape\color{black}
Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure6}}.Short
