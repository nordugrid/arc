...
\begin{figure}[ht]
\centering{\resizebox{255px}{!}{\includegraphics{JobDescriptionExample-XRSLInput.jpg}}
\caption{\label{fig:Chart 1}The figure shows how the different classes participating in the job description translation process interrelate in an example about xRSL parsing.}}
\end{figure}
