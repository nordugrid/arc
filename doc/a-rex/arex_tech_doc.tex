...
computational job and executing it in underlying local batch system.
...
\begin{tabular}{|>{\centering}p{0.15\columnwidth}|>{\centering}p{0.15\columnwidth}|c|>{\raggedright}p{0.4\columnwidth}|}
\hline 
...
\end{itemize}
\begin{comment} (LRMS\_COMMENT) For more information see section
\ref{sub:LRMS}.\end{comment}
...
and configuration options please read dedicated documentation at \cite{backends-arc1}.
