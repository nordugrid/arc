...
\lstinputlisting[
	...
	caption={[Header file of the Time Web Service. Filename: timeservice.h]
	\textbf{Header file of the Time Web Service. Filename: timeservice.h}}
	]%
{../src/services/timeservice/timeservice.h}%
As to be seen, the class \textit{Service} renders the possibility to implement the method \textit{process}.
...
The Time Web Service uses the namespace \textit{ArcService}.
...
\lstinputlisting[
	...
	caption={[Implementation of the Time Web Service. Filename: timeservice.cpp]
	\textbf{Implementation of the Time Web Service. Filename: timeservice.cpp}}
	]%
{../src/services/timeservice/timeservice.cpp}%


The method \textit{process} is defined in line~\ref{lst_code:time_cpp_process} and realises the desired service,
