...
Depending on the path of the URL the Plexer passes messages to a defined SOAP service which again passes the message to the Web Service~\cite{QIANG_2005}. \task{Add text here}\\
...
\footnote{\task{refer to the appendix in which the documentation to arc-hed is specified}}
