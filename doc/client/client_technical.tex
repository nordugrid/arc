...
\item{A job identification string does not uniguely define which grid flavour runs a certain job. Thus this information is stored 
...
\item{Residing within the {\JobSupervisor} the {\JobController}s are now accesible for external calls (i.e. job handling).}
\end{enumerate}
