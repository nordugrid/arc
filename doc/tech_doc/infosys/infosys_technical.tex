...
\textit{This section extensively uses terms defined in "ARC Security Framework (NORDUGRID-TECH-16)" document"~\cite{arcsec}.}
...
\textit{For information about sophisticated authorization policies and how to deploy various Policy Decision Point entities please see "ARC Security Framework (NORDUGRID-TECH-16)" document"~\cite{arcsec}.}
