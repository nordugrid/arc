...
\textit{This section extensively uses terms defined in "Security Framework of WS-ARC" document"~\cite{arcsec}.}
...
\textit{For information about sophisticated authorization policies and how to deploy various Policy Decision Point entities please see "Security Framework of WS-ARC" document"~\cite{arcsec}.}
