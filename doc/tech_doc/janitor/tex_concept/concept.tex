...
a setuid wrapper has been written. During the installation \task{not done yet} the mode of rjanitor will be set to \texttt{u+s}
to make the binary suid root. \task{According to Daniel: ``A future version of the Janitor will get rid of the suid root helper.''}\\
