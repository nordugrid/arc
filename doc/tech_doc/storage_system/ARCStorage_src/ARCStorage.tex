...
framework. In this paper, we will present an overview of ARC's novel storage system -- the NorduGrid storage -- itself a set of services providing a self-healing,
