  ...
  For ARC $\leq$ 0.5.25, UI created a dummy executable attribute for internal GM use,
  ...
  \begin{shaded}
    \xrsl{cache}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.34, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{cpuTime}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.17\footnote{Was called \texttt{maxCpuTime} for ARC $\leq$ 0.3.16.}, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{wallTime}
  \end{shaded}
  \versions{ARC $\geq$ 0.5.27, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{gridTime}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.31, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{benchmarks}
  \end{shaded}
  \versions{ARC $\geq$ 0.5.14, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{memory}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.17\footnote{Was called \texttt{maxMemory} for ARC $\leq$ 0.3.16}, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{disk}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.17\footnote{Was called \texttt{maxDisk} for ARC $\leq$ 0.3.16}, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \begin{shaded}
    \xrsl{opsys}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.21, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
...
%  otherwise it will be forced to that list by the UI.
  ...
  \begin{shaded}
    \xrsl{acl}
  \end{shaded}
  \versions{ARC $\geq$ 0.5.12, ARC 0.6}
  ...
  \begin{shaded}
    \xrsl{nodeAccess}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.24, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
...
%%   Specifies a type of job (default is \texttt{single}).
  ...
  \begin{shaded}
    \xrsl{count}
  \end{shaded}
  \versions{ARC $\geq$ 0.3.12, ARC 0.4, ARC 0.5, ARC 0.6}
  \begin{tabular}{lp{13cm}}
  ...
  \end{shaded}
  \versions{ARC $\geq$ 0.5.45, ARC 0.6}
  \begin{tabular}{lp{13cm}}
