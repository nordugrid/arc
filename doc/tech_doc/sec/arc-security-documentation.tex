...
\section{Security architecture in HED: SecHandler and PDP} % (fold)
\label{sec:sec_architecture}


\subsection{Structure of SecHandler and PDP} % (fold)
...
\subsection{Schemas for policy evaluation engine} % (fold)
...
\subsection{Basic Elements of Policy} % (fold)
...
\subsection{Policy Matching} % (fold)
...
\subsection{Request Structure} % (fold)
...
\subsection{Rule Composition and Matching} % (fold)
...
\subsection{Rule Elements Matching} % (fold)
...
\section{Policy Decision Service} % (fold)
...
\section{Security Attributes} % (fold)
...
\subsection{Interface of policy decision service} % (fold)
