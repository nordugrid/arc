...
{\centering\selectlanguage{english}\itshape\color{black}
Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure5}}. The
...
{\centering\selectlanguage{english}\itshape\color{black}
Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure6}}. The
flow diagram of delegation procedure with certificate transferred as
...
{\textless}/Policy{\textgreater}}
\end{enumerate}
\subsubsection[PDP Service Invoker configuration]{PDP Service Invoker
configuration}
{\selectlanguage{english}\upshape\color{black}
...
{\centering\selectlanguage{english}\itshape\color{black}
Figure
{\refstepcounter{Figure}\theFigure\label{seq:refFigure7}}.\textbf{
...
\end{center}
{\centering\selectlanguage{english}\itshape\color{black}
Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure8}}.Short
