...
National Grid Association~\cite{swing} has chosen ARC as their middleware.
...
and different grid capabilities are implemented as Web Services residing in HED.
...
NorduGrid Web site~\cite{nordugrid} for details). Ongoing and completed Grid
