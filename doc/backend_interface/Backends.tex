...
\vspace*{3mm}
The following properties referring to job counts are calculated based on information in GridManager's status files:
...
\hline
SchedulingPolicy & if maui is used, set to \texttt{fairshare} \\
\hline
