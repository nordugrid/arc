...
This can be put in a seperate file, and then use the \textbf{FromFile} attribute of the ClientSSLConfig section to specify where the file is.
...
\begin{verbatim}
    <Service name="pythonservice" id="librarian">
        ...
        <TrustManager FromFile='librarian_trust_manager.xml'/>
    </Service>
\end{verbatim}
