...
%% filesystem  for storing metadata. And the number of protocol
...
%% %% first level is stored in Chubby, making Chubby a vitally important part
...
%% uses centralized metadata catalog (MCat). Also supports several file
