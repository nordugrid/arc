...
special utility also exists for test purposes. These commands replace
the commands \texttt{ng*} (\texttt{ngsub,} \texttt{ngget} etc.) found
in ARC versions previous to 0.9, and provide enhanced functionality.
