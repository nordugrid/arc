...
%%% This does not seem to be correct. The echo client seems to use a normal INI client configuration. Some one please verify this...
...
%~ environment
%~ variable, the configuration file is assumed to be \verb|echo_client.conf| in
