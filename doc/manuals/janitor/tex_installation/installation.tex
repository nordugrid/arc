...
\begin{table}[!h]
   \begin{center}
        \mycaption{Required perl packages for Janitor.}{Log4perl is used for the internal logging of Janitor, while the 
                   Redland RDF libraray is used for accessing the knowledge base of Runtime Environments.}
...
The parameter \texttt{enable} defines whether the Janitor shall be used within A-REX or not. Use the value \texttt{"0"} to disable Janitor. The
