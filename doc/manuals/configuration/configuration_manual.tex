...
\lstinputlisting[language=xml]{gsi.xsd}

\subsection{HTTP MCC Schema}
\lstinputlisting[language=xml]{http.xsd}

\subsection{ARC Authorization Security Handler Schema}
\lstinputlisting[language=xml]{ArcAuthZ.xsd}

\subsection{UsernameToken Security Handler Schema}
\lstinputlisting[language=xml]{UsernameTokenSH.xsd}

\subsection{X.509 Token Security Handler Schema}
\lstinputlisting[language=xml]{X509TokenSH.xsd}

\subsection{ARC PDP Schema}
\lstinputlisting[language=xml]{ArcPDP.xsd}

\subsection{XACML PDP Schema}
\lstinputlisting[language=xml]{XACMLPDP.xsd}

\subsection{Delegation PDP Schema}
\lstinputlisting[language=xml]{DelegationPDP.xsd}

\subsection{Service Invoker PDP Schema}
\lstinputlisting[language=xml]{PDPServiceInvoker.xsd}

\subsection{Simple List PDP Schema}
\lstinputlisting[language=xml]{SimpleListPDP.xsd}
