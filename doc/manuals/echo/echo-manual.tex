...
%%%%---- The title ----
{\centering \textsc{\Large The Echo Service - The Missing Manual}\Large \par}
\vspace*{0.5cm}
...
\vspace*{1.5cm}
%%%%---- A list of authors ----
    {\centering \large The Unknown Knowarcer\footnote{nordugrid-discuss@nordugrid.org} \large \par}
\end{titlepage}
