...
\hypersetup{
  pdfauthor = {M. Ellert, J. J\"{o}nemo, A. Konstantinov, M. Norden, W. Qiang, F. Szalai},
...
\vspace*{1.5cm}
%%%%---- A list of authors ----
    {\centering \large M. Ellert, J. J\"{o}nemo\footnote{johan.jonemo@hep.lu.se}, A. Konstantinov\footnote{aleksandr.konstantinov@fys.uio.no}, M. Nord\'{e}n, W. Qiang, F. Szalai \large \par}
