...
\hypersetup{
  pdfauthor = {J. J\"{o}nemo, A. Konstantinov},
...
\vspace*{1.5cm}
%%%%---- A list of authors ----
    {\centering \large J. J\"{o}nemo\footnote{johan.jonemo@hep.lu.se}, A. Konstantinov\footnote{aleksandr.konstantinov@fys.uio.no} \large \par}
