...
The server side TCP MCC generates \texttt{PayloadStreamInterface} payload in the Message passed to next MCC whihc can be used for communicationg through open TCP channel. Currently it ignores any payload attached to the returned Message.
}{}
